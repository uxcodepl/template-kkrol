 ...
 */
// mikrodata https://schema.org/address
	...
	<?php if ($this->params->get('show_info', 1)) : ?>
		...
		<?php if ($this->contact->con_position && $tparams->get('show_position')) : ?>
			<dl class="contact-position dl-horizontal">
				<dt><?php //echo JText::_('COM_CONTACT_POSITION'); ?> <?php echo $this->contact->con_position; ?></dt>
		...
		if ($this->contact->telephone) 
			{echo 'telefon:'. $this->contact->telephone;}
		echo '<li>'.$this->contact->email_to.'</li>'; 
		echo '<li>'.$this->contact->address.'</li>'; 
		echo '<li>'.$this->contact->postcode.' '.$this->contact->suburb.'</li>'; 
		//echo '<li>&nbsp;</li>';
		//echo '<li>'.$this->contact->state.'</li>'; 
		//echo '<li>'.$this->contact->sortname3.'</li>'; 
		echo '</ul>';
		?>
